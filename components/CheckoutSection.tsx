...
export function CheckoutSection() {
  ...
  if (items.length === 0) {
    return (
      <div className="min-h-screen pt-20 pb-12 flex items-center justify-center bg-black">
    ...
    <div className="min-h-screen pt-20 pb-12 bg-black">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-yellow-400 via-amber-500 to-yellow-600 bg-clip-text text-transparent mb-4">
            Checkout
          </h1>
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">Complete your purchase of premium AI agents</p>
        </div>
